        ...
        <div class="container mx-auto px-4 py-4">
            <div class="flex justify-between items-center">
                ...
                <nav class="flex items-center space-x-6">
                    <a href="{{ route('vitrine.index') }}" class="hover:text-gray-200 transition-colors">
                        <i class="fas fa-home mr-2"></i>Início
                    </a>
                    <a href="{{ route('vitrine.checkout') }}" class="hover:text-gray-200 transition-colors relative">
